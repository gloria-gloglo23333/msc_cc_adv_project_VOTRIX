...
**1、leap motion interaction code**

`msc_cc_adv_project_VOTRIX/Assets/0605export/-Scripts/Rotator.cs`
...
**2、Camera auto motion script**

`msc_cc_adv_project_VOTRIX/Assets/0605export/-Scripts/CamaraRotator.cs`

Automate the camera movement logic to achieve automatic level selection and access to levels in the main interface

**3、Audio sequence recording + sequencing script**

`msc_cc_adv_project_VOTRIX/Assets/0605export/-Scripts/AudioClipList.cs`
...
**4、Portal effect + teleportation script**
...
[https://www.youtube.com/watch?v=cuQao3hEKfs](https://www.youtube.com/watch?v=cuQao3hEKfs "https://www.youtube.com/watch?v=cuQao3hEKfs")

**5、Participate in scene building**
